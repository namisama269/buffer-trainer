...
var mathlib = (function() {
	...
	function createMoveHash(initState, validMoves, hashFunc, moveFunc) {
		...
		console.log('[move hash] ' + states.length + ' states generated, tt=', +new Date - tt, JSON.stringify(depthEnds));
	...
	*/
	...
	_.updatePrun = function(targetDepth) {
		...
		for (var depth = this.prunDepth + 1; depth <= targetDepth; depth++) {
			...
			console.log('[gSolver] updatePrun', depth, this.prunTableSize - this.prevSize, +new Date - t);
